                    ...
                    <ul className="metismenu list-unstyled" id="side-menu">
                        ...
                        {/* <li>
                            <Link to="/batismo">
                                ...
                                <span className="ms-1">BATISMO</span>
                            </Link>
                        </li> */}
                        ...
                        {/* <li>
                            <Link to="/planoleitura">
                                <i className="ri-book-2-line"></i>
                                <span className="ms-1">PLANO DE LEITURA</span>
                            </Link>
                        </li> */}
                        ...
                        {/* <li>
                            <Link to="/atualizacoes">
                                <i className="ri-book-read-fill"></i>
                                <span className="ms-1">ATUALIZAÇÕES</span>
                            </Link>
                        </li> */}
                        ...
                        <li>
                            <Link to="/lives">
                                ...
                                <span className="ms-1">LIVES</span>
                            </Link>
                        </li>
